...
export class PositionMasterComponent implements OnInit {
  ...
  toolbarActions: TableAction[] = [
    {
      ...
      visible: () => this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_CREATE),
    },
    {
      ...CommonActions.uploadExcel({
        templateUrl: () => this.apiService.POSITION_MASTER.EXCEL_TEMPLATE,
        importUrl: () => this.apiService.POSITION_MASTER.EXCEL_IMPORT,
        entityName: this.ENTITY_KEY,
        onSuccess: () => this.loadData(),
      }),
      visible: () => this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_IMPORT_EXCEL),
    },
    {
      ...CommonActions.exportExcel(() => this.exportExcel()),
      visible: () => this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_EXPORT_EXCEL),
    },
  ];
  ...
  rowActions: RowAction[] = [
    {
      ...
      severity: 'primary',
      visible: () => this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_VIEW),
    ...
    },
    {
      ...
      severity: 'info',
      visible: () => this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_UPDATE),
    ...
    },
    {
      ...
      visible: (record) =>
        ...
        this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_ACTIVATE),
    ...
    },
    {
      ...
      visible: (record) =>
        ...
        this.permissionSvc.has(PERMISSION_CODES.ORG_POSITION_MASTER_DEACTIVATE),
  ...
  exportExcel() {
    ...
    return this.apiService.postBlob(this.apiService.POSITION_MASTER.EXCEL_EXPORT, payload).pipe(
      tap({
        next: (response) => {
          this.excelLoading = false;
          const blob = response.body;
