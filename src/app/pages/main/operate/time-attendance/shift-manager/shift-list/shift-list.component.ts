...
export class ShiftListComponent implements OnInit {
  private readonly ENTITY_KEY = 'timeAttendance.shift.entityName';
  ...
  filterFields: FilterField[] = [
    {
      key: 'code',
      label: 'timeAttendance.shift.code',
      type: 'input',
      placeholder: 'timeAttendance.shift.searchCode',
      col: 6,
      allowClear: true,
    },
    {
      key: 'name',
      label: 'timeAttendance.shift.name',
      type: 'input',
      placeholder: 'timeAttendance.shift.searchName',
      col: 6,
      allowClear: true,
    },
    {
      key: 'companyId',
      label: 'timeAttendance.shift.companyName',
      type: 'select',
      placeholder: 'timeAttendance.shift.filterCompany',
      col: 6,
      allowClear: true,
      options: [],
    },
    {
      key: 'isDeleted',
      label: 'timeAttendance.shift.status',
      type: 'select',
      placeholder: 'timeAttendance.shift.filterStatus',
      col: 6,
      allowClear: true,
      options: [
        { label: 'timeAttendance.shift.statusActive', value: false },
        { label: 'timeAttendance.shift.statusInactive', value: true },
      ],
    },
  ];
  ...
  columns: TableColumn[] = [
    { field: 'code', header: 'timeAttendance.shift.code', type: 'text', sortable: true },
    { field: 'name', header: 'timeAttendance.shift.name', type: 'text', sortable: true },
    { field: 'startTime', header: 'timeAttendance.shift.startTime', type: 'text' },
    { field: 'endTime', header: 'timeAttendance.shift.endTime', type: 'text' },
    { field: 'breakMinutes', header: 'timeAttendance.shift.breakMinutes', type: 'text' },
    { field: 'workingMinutes', header: 'timeAttendance.shift.workingMinutes', type: 'text' },
    { field: 'companyName', header: 'timeAttendance.shift.companyName', type: 'text' },
    { field: 'status', header: 'timeAttendance.shift.status', type: 'boolean' },
  ];
  ...
  rowActions: RowAction[] = [
    {
      key: 'edit',
      icon: 'edit',
      tooltip: 'timeAttendance.shift.edit',
      severity: 'info',
    ...
    },
    {
      key: 'activate',
      icon: 'check-circle',
      tooltip: 'timeAttendance.shift.activate',
      severity: 'success',
    ...
    },
    {
      key: 'deactivate',
      icon: 'stop',
      tooltip: 'timeAttendance.shift.deactivate',
      severity: 'danger',
