...
import { AddOrUpdateContractTypeComponent } from './contract/contract-type-manager/add-or-update-contract-type/add-or-update-contract-type.component';
import { ContractTypeManagerComponent } from './contract/contract-type-manager/contract-type-manager.component';
import { AddOrUpdateContractComponent } from './contract/contract-manager/add-or-update-contract/add-or-update-contract.component';
import { ContractDetailComponent } from './contract/contract-manager/contract-detail/contract-detail.component';
import { ContractManagerComponent } from './contract/contract-manager/contract-manager.component';
import { AddOrUpdateReviewRenewalComponent } from './contract/review-renewal-manager/add-or-update-review-renewal/add-or-update-review-renewal.component';
import { ReviewRenewalManagerComponent } from './contract/review-renewal-manager/review-renewal-manager.component';
...
import { AddOrUpdateTransferComponent } from './transfer/transfer-manager/add-or-update-transfer/add-or-update-transfer.component';
import { TransferDetailComponent } from './transfer/transfer-manager/transfer-detail/transfer-detail.component';
import { TransferManagerComponent } from './transfer/transfer-manager/transfer-manager.component';
