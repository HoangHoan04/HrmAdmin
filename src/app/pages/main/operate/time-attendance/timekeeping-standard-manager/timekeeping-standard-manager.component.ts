  ...
  rowActions: RowAction[] = [
    {
      ...
      severity: 'info',
      visible: () => this.permissionSvc.has(PERMISSION_CODES.OPERATE_TIMEKEEPING_STANDARD_UPDATE),
    ...
    },
    {
      ...
      visible: (record) =>
        ...
        this.permissionSvc.has(PERMISSION_CODES.OPERATE_TIMEKEEPING_STANDARD_ACTIVATE),
    ...
    },
    {
      ...
      visible: (record) =>
        ...
        this.permissionSvc.has(PERMISSION_CODES.OPERATE_TIMEKEEPING_STANDARD_DEACTIVATE),
